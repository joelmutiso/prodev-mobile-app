    ...
    <SafeAreaProvider>
      <SafeAreaView className="flex-1 p-4 bg-gray-50">
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View className="gap-3 bg-white rounded-md p-4 mb-4">
            {/* My Account */}
            <Pressable className="flex-row items-center justify-between mb-2">
              <View className="flex-row items-center gap-4">
                ...
                <View>
                  ...
                  <Text className="font-thin text-gray-700 text-xs">
            ...
            <Pressable className="flex-row items-center justify-between mb-2">
              <View className="flex-row items-center gap-4">
                ...
                <View>
                  <Text className="text-lg font-normal mb-1">Two-Factor Auth</Text>
                  <Text className="font-thin text-gray-700 text-xs">
          ...
          {/* More Section */}
          <View className="gap-3 bg-white rounded-md p-4 mb-10">
            <Pressable className="flex-row items-center justify-between mb-2">
              <View className="flex-row items-center gap-4">
                <View className="w-12 h-12 bg-[#0601B4]/10 items-center justify-center rounded-full">
                  <Ionicons name="notifications-outline" size={24} color="#0601B4" />
                </View>
                <View>
             ...
             <Pressable className="flex-row items-center justify-between mb-2">
              <View className="flex-row items-center gap-4">
                <View className="w-12 h-12 bg-[#0601B4]/10 items-center justify-center rounded-full">
                  <Ionicons name="heart-outline" size={24} color="#0601B4" />
                </View>
                <View>
                  <Text className="text-lg font-semibold mb-1">About App</Text>
                  <Text className="font-thin text-gray-700 text-xs">
